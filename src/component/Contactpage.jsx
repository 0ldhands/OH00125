      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-10 bg-white shadow-xl rounded-2xl p-8">
        ...
        <div className="flex flex-col justify-start space-y-6">
          ...
          <p className="text-gray-600">
            We'd love to hear from you! Reach out through our contact info or send us a message.
          </p>

          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              <Mail className="w-6 h-6 text-blue-600" />
              <span className="text-gray-700">sekar2486@gmail.com</span>
            </div>
            <div className="flex items-center space-x-4">
              <Linkedin className="w-6 h-6 text-blue-600" />
              <span className="text-gray-700">https://www.linkedin.com/in/sekar2486/
</span>
            </div>
            <div className="flex items-center space-x-4">
              <Phone className="w-6 h-6 text-green-600" />
              <span className="text-gray-700">+91-9843938246</span>
            </div>
            <div className="flex items-center space-x-4">
              <MapPin className="w-6 h-6 text-red-600" />
              <span className="text-gray-700">No. 58/110, Chamundi Street, Gugai, Salem - 636006</span>
            </div>
