  ...
  return (
    <motion.div
      className={`relative flex flex-col items-center ${
        theme ? "bg-violet-600/80" : "bg-gray-600/80"
      } rounded-xl p-4 shadow-md hover:shadow-violet-400/50 cursor-pointer backdrop-blur-sm transition-transform duration-300 hover:scale-110 hover:-translate-y-2`}
...
export default function Skill() {
  ...
  return (
    <div className="relative sm:m-6 m-4 rounded-2xl overflow-hidden">
      ...
      <div
        className={`absolute inset-0 ${theme ? "wave-bg" : "wave-bgb"} opacity-95`}
      ></div>
